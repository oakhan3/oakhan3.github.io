export const BACKGROUND_ALPHA = 0.75
export const BOX_PADDING_PX = 16
...
export const QUEST_ROW_HEIGHT_MOBILE_PX = 20
export const QUEST_ROW_HEIGHT_DESKTOP_PX = 16
...
export const OVERLAY_BODY_LINE_SPACING_PX = 8

// NOTE: Vertical gap between the bottom of the title and the separator line.
export const OVERLAY_SEPARATOR_OFFSET_PX = 6
